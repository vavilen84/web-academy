	...
	<div class="fleft w25per">
		...
		<div class="row">
			<?php $form=$this->beginWidget('CActiveForm', [
				'id'=>'fileupload',
				'action'=>Yii::app()->createUrl('site/imageupload',['typeId'=>ImageComponent::IMAGE_ENTITY_TYPE]),
		...
		<div class="row">
			...
			<?php echo $form->dropDownList($model,'gallery_id', Yii::app()->gallery->getGalleriesList()); ?>
	...
	<div class="fright w70per">
		<div id="original-image">
			<?php if($model->image_original): ?>
				<img src="<?php echo ImageComponent::IMAGE_ORIGINAL_PATH.$model->image_original; ?>"
					 alt="" class="entity-original-image" data-filename="<?php echo $model->image_original; ?>">
			<?php endif;?>
		</div>
		<div id="preview-image">
			<?php if($model->image_preview): ?>
				<img src="<?php echo ImageComponent::IMAGE_PREVIEW_PATH.$model->image_preview; ?>"
		...
		<?php echo CHtml::hiddenField('type-id',ImageComponent::IMAGE_ENTITY_TYPE);?>
